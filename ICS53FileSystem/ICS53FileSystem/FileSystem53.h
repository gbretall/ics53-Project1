...
//============================================================================
#ifndef FILESYSTEM53_H
#define FILESYSTEM53_H
...
class FileSystem53 {
	...
	// +-------------------------------------+
	//   bytemap: Each byte represent a block in a disk. MAX_BLOCK_NO/8 bytes
	...
	descriptor* desc_table;
	char* open_file_table;
	 ...
	 */
	descriptor read_descriptor(int no);
	 ...
	 *    none
	 */
	void write_descriptor(int no, descriptor desc);
	 ...
	 */
	int search_dir(string symbolic_file_name);
